...
#抄自 https://github.com/Quan666/ELFChatBot
...
async def getchatasync(msg, baidubot):
    return await baidubot.sendMsg(msg)

def getchat(msg, baidubot):
    loop = asyncio.get_event_loop()
    task = asyncio.ensure_future(getchatasync(msg, baidubot))
